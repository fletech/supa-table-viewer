...
const ApplicationsChart = ({ 
  ...
  const chartData = useMemo(() => {
    if (type === 'status') {
      ...
      // Create date range array with all days
            ...
            {type === 'status' ? (
              ...
              >
                ...
                <XAxis 
                  ...
                  height={60}
                />
                <YAxis allowDecimals={false} domain={yAxisDomain} tick={{ fontSize: 10 }} />
                <Tooltip content={<CustomTooltip />} />
                <Legend />
                <Bar name="Actives" dataKey="Actives" fill="#4F46E5" radius={[2, 2, 0, 0]} />
                <Bar name="Archived" dataKey="Archived" fill="#9CA3AF" radius={[2, 2, 0, 0]} />
              </BarChart>
            ) : (
              <LineChart
                data={chartData}
